...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: XnjXtIWN8Mpf/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__fb4Wn)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__jbqC7)}
              role={"img"}
            />
          ),
